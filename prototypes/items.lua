...
data:extend({
	{
		...
		icon = "__pelagos__/graphics/degradation-module/degradation-module-1.png",
		subgroup = "module",
		color_hint = { text = "Q" },
		category = "quality",
		tier = 1,
	...
	},
	{
		...
		localised_description = { "item-description.degradation-module" },
		icon = "__pelagos__/graphics/degradation-module/degradation-module-2.png",
		subgroup = "module",
		color_hint = { text = "Q" },
		category = "quality",
		tier = 2,
	...
	},
	{
		...
		localised_description = { "item-description.degradation-module" },
		icon = "__pelagos__/graphics/degradation-module/degradation-module-3.png",
		subgroup = "module",
		color_hint = { text = "Q" },
		category = "quality",
		tier = 3,
