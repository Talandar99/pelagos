...
data:extend({
	{
		...
		icon = "__pelagos__/graphics/diesel-long-handed-inserter/long-handed-diesel-inserter-engine.png",
		subgroup = "inserter",
		color_hint = { text = "L" },
		...
		place_result = "long-handed-diesel-inserter",
	...
	},
	{
		...
		minable = { mining_time = 0.1, result = "long-handed-diesel-inserter" },
		max_health = 150,
		...
		hand_base_picture = {
			filename = "__pelagos__/graphics/diesel-long-handed-inserter/long-handed-inserter-hand-base.png",
			priority = "extra-high",
			width = 32,
			height = 136,
			scale = 0.25,
		...
		hand_closed_picture = {
			filename = "__pelagos__/graphics/diesel-long-handed-inserter/long-handed-inserter-hand-closed.png",
			priority = "extra-high",
			width = 72,
			height = 164,
			scale = 0.25,
		...
		hand_open_picture = {
			filename = "__pelagos__/graphics/diesel-long-handed-inserter/long-handed-inserter-hand-open.png",
			priority = "extra-high",
			width = 72,
			height = 164,
			scale = 0.25,
