...
data:extend({
	{
		...
		icon = "__pelagos__/graphics/thruster/ethanol_thruster.png",
	...
	},
	{
		...
		--max_performance = { fluid_volume = 0.8, fluid_usage = 0.25, effectivity = 0.1 },
		min_performance = { fluid_volume = 0.1, fluid_usage = 0.025, effectivity = 0.3 },
		max_performance = { fluid_volume = 0.9, fluid_usage = 0.25, effectivity = 0.1 },
		fuel_fluid_box = {
			filter = "ethanol",
		...
		graphics_set = {
			animation = util.sprite_load("__pelagos__/graphics/thruster/thruster", {
				animation_speed = 0.5,
				frame_count = 64,
				scale = 0.5,
				shift = { 0, 3 },
