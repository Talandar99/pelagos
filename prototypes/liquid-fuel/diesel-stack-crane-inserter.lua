...
data:extend({
	...
	},
	{
		...
		integration_patch = make_4way_animation_from_spritesheet({
			layers = {
				{
					filename = "__pelagos__/graphics/diesel-titanium-crane-stack-inserter/platform-stack-overlay.png",
					priority = "extra-high",
					width = 384,
					height = 192,
					scale = 0.5,
		...
		platform_picture = make_4way_animation_from_spritesheet({
			layers = {
				{
					filename = "__pelagos__/graphics/diesel-titanium-crane-stack-inserter/platform-stack.png",
					priority = "extra-high",
					width = 384,
					height = 192,
					scale = 0.5,
